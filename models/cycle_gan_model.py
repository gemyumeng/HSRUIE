...
class CycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.netSAD.load_state_dict(torch.load('/home/DATA_yuanbao/ym/Mynet1/checkpoints/maps_cyclegan/latest_net_SAD.pth',map_location={'cuda:1':'cuda:0'}))

        self.netNC = FE().cuda()
        self.netNC.load_state_dict(
            torch.load('/home/DATA_yuanbao/ym/Mynet1/checkpoints/maps_cyclegan/latest_net_NC.pth',
